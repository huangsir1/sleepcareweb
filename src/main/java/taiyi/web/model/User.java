...
public class User {
    ...
    public String getGender(boolean flag) {
        return gender.equals("男") ? "male" : "female";
    }
    ...
    public String getEssResult() {
        String result;
        if (essRank <= 9 ) {
        	result = Internationalization.NORMAL;
		} else if (essRank >= 10 && essRank <= 13) {
            result = Internationalization.MILD_SLEEPINESS;
        } else if (essRank >= 14 && essRank <= 19) {
            result = Internationalization.MODERATE_SLEEPINESS;
        } else {
            result = Internationalization.SEVERE_SLEEPINESS;
        }
        return result;
    }
	/* 
