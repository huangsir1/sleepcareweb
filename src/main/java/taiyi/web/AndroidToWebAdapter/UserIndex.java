...
public class UserIndex implements Serializable {
	...
	public UserIndex(int id, String ahiIndex, String hxztIndex, String dtqIndex, String yjzcsIndex, String pjxybhdIndex,
			...
			String reportfilepath, int scoreHxzb, String avgxlgzd, String osahsdegree, String dyxzdegree,
			int zchxzthour, int zchxztminute, int zchxztsec, int hxhapperhour, int hxhapperminute, int hxhappersec,
			int hxztzsjhour, int hxztzsjminute, int hxztzsjsec, int zcdtqhour, int zcdtqminute, int zcdtqsec,
			int dtqhapperhour, int dtqhapperminute, int dtqhappersec, int dtqzsjhour, int dtqzsjminute, int dtqzsjsec,
			String xyodi, String smsober, String smmax, int axyfbzsjhour, int axyfbzsjminute, int axyfbzsjsec,
			String ayjzcsnum, int bxyfbzsjhour, int bxyfbzsjminute, int bxyfbzsjsec, String byjzcsnum, int cxyfbzsjhour,
			int cxyfbzsjminute, int cxyfbzsjsec, String cyjzcsnum, int dxyfbzsjhour, int dxyfbzsjminute,
			int dxyfbzsjsec, String dyjzcsnum, int exyfbzsjhour, int exyfbzsjminute, int exyfbzsjsec, String eyjzcsnum,
			int fxyfbzsjhour, int fxyfbzsjminute, int fxyfbzsjsec, String fyjzcsnum, String udegree, int maxyjcxhour,
			int maxyjcxminute, int maxyjcxsec, int maxyjfshour, int maxyjfsminute, int maxyjfssec, int longyjcxhour,
			int longyjcxminute, int longyjcxsec, int longyjfshour, int longyjfsminute, int longyjfssec,
			String xywhzsIndex, String uuid, int upload, int maxyjcxtimes, int maxyjfstimes, int longyjcxtimes,
			int longyjfstimes, int zchxzttimes, int hxhappertimes, int hxztzsjtimes, int zcdtqtimes, int dtqhappertimes,
			int dtqzsjtimes, int axyfbzsjtimes, int bxyfbzsjtimes, int cxyfbzsjtimes, int dxyfbzsjtimes,
			int exyfbzsjtimes, int fxyfbzsjtimes) {
		super();
		this.id = id;
