...
public class UserSleep implements Serializable {
	public static void main(String[] args) {
		DataOfAndroidToWebAdapterImpl dataOfAndroidToWebAdapterImpl = new DataOfAndroidToWebAdapterImpl();
//		System.out.println(
//				dataOfAndroidToWebAdapterImpl.binaryFileToBaseReport(new File("/Users/jason/Desktop/source.txt")));
		System.out.println(
				dataOfAndroidToWebAdapterImpl.originalFileToBaseReport(new File("/Users/jason/Desktop/s.txt")));
	}
