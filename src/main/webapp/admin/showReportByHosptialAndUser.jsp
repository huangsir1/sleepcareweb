...
<script type="text/javascript">
	function jump() {
		...
		if (row) {
			window.location.href = "${basePath}admin/showReport/" + row.id;
		}
	...
	$(function() {
		$('#dg').datagrid(
				{
					url : '${basePath}admin/getReportByHospitalAndUser/'+getQueryString("hosptialId")+'/'+getQueryString("userId"),
					pageSize : 20,
...
<body>
	...
	<div id="toolbar">
		<a href="#" class="easyui-linkbutton" plain="true" onclick="jump()">查看报告</a>
		<a href="#" class="easyui-linkbutton" iconCls="icon-remove"
			plain="true" onclick="del()">删除报告</a> <a href="#"
