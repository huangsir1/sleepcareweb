...
<script type="text/javascript">
	function jump() {
		...
		if (row) {
			window.location.href = "${basePath}admin/showReportByHosptialAndUser.jsp?userId="+ row.id + "&hosptialId="+ getQueryString("id");
		}
	...
	$(function() {
		$('#dg').datagrid({
			url : '${basePath}admin/getUserByHospital/' + getQueryString("id"),
			pageSize : 20,
...
<body>
	...
	<div id="toolbar">
		...
		<a href="#" class="easyui-linkbutton" iconCls="icon-add" plain="true"
			onclick="newUser()">增加用户</a> <a href="#" class="easyui-linkbutton"
